...
export const translations = {
  en: {
    ...
    'cases.calculator.title': 'Financial Calculator',
    'cases.calculator.client': 'Finance Company',
    'cases.calculator.description': 'Advanced calculator for complex financial calculations.',
    'cases.calculator.result1': '+50% speed',
    'cases.calculator.result2': '2 months',
    'cases.calculator.result3': '10K+ calculations/day',
  ...
  ru: {
    ...
    'cases.calculator.title': 'Финансовый калькулятор',
    'cases.calculator.client': 'Финансовая компания',
    'cases.calculator.description': 'Продвинутый калькулятор для сложных финансовых расчетов.',
    'cases.calculator.result1': '+50% скорость',
    'cases.calculator.result2': '2 месяца',
    'cases.calculator.result3': '10K+ расчетов/день',
  ...
  kz: {
    ...
    'cases.calculator.title': 'Қаржылық калькулятор',
    'cases.calculator.client': 'Қаржылық компания',
    'cases.calculator.description': 'Күрделі қаржылық есептеулерге арналған кеңейтілген калькулятор.',
    'cases.calculator.result1': '+50% жылдамдық',
    'cases.calculator.result2': '2 ай',
    'cases.calculator.result3': '10K+ есептеу/күн',
